...
{
    /// <inheritdoc />
    public partial class InitializeFullDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    EmploymentType = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpenseType = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseAllocations_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpenseAllocations_Transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_UserId_CategoryId_Year_Month_Quarter",
                table: "Budgets",
                columns: new[] { "UserId", "CategoryId", "Year", "Month", "Quarter" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_Name_OrganizationId_CategoryType",
                table: "Categories",
                columns: new[] { "Name", "OrganizationId", "CategoryType" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseAllocations_EmployeeId",
                table: "ExpenseAllocations",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpenseAllocations_TransactionId",
                table: "ExpenseAllocations",
                column: "TransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpenseAllocations_TransactionId_EmployeeId",
                table: "ExpenseAllocations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ExpenseType",
                table: "Transactions",
                column: "ExpenseType");
