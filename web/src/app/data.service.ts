...
export class DataService {
	...
	getUser(): Observable<User> {
		return this.http.get<User>("https://localhost:7278/auth/profile");						
	}
	...
	updateUser(user: User): Observable<User> {
        ...
        return this.http.put<User>("https://localhost:7278/auth/profile", updatePayload).pipe(
